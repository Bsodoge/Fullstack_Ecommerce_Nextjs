...
export default function Checkout() {
    ...
    const handleSubmit = (e : SubmitEvent) => {
        e.preventDefault();
        const validationErrors : IAddressValidation = {
            email: '',
            country: '',
            firstName: '',
            lastName: '',
                    ...
                    formStage === 'details' ?
                        <form action="" className={styles.form} ref={form} onSubmit={handleSubmit}>
                            <div className={styles.contact}>
                                ...
                                {addressErrors.email ? <span>{addressErrors.email}</span> : <></>}
                            </div>
                            <div className={styles.shipping}>
                                ...
                                <div className={styles.input}>
                                    <input type="text" name="firstName" id="" placeholder="First Name" onChange={handleChange} required />
                                    {addressErrors.firstName ? <span>{addressErrors.firstName}</span> : <></>}
                                    <input type="text" name="lastName" id="" placeholder="Last Name" onChange={handleChange} required />
                                    {addressErrors.lastName ? <span>{addressErrors.lastName}</span> : <></>}
                                </div>
                                <div className={styles.input}>
                                    <input type="text" name="address" id="" placeholder="Address" onChange={handleChange} required />
                                    {addressErrors.address ? <span>{addressErrors.address}</span> : <></>}
                                </div>
                                <div className={styles.input}>
                                    <input type="text" name="apartment" id="" placeholder="Apartment,suite, etc. (optional)" onChange={handleChange}/>
                                </div>
                                <div className={styles.input}>
                                    <input type="text" name="city" id="" placeholder="City" onChange={handleChange} required />
                                    {addressErrors.city ? <span>{addressErrors.city}</span> : <></>}
                                    <input type="text" name="county" id="" placeholder="County" onChange={handleChange} required />
                                    {addressErrors.county ? <span>{addressErrors.county}</span> : <></>}
                                    <input type="text" name="postcode" id="" placeholder="Postcode" onChange={handleChange} required />
                                    {addressErrors.postcode ? <span>{addressErrors.postcode}</span> : <></>}
                                </div>
                            </div>
                        ...
                        <form action="" className={styles.form} ref={form}>
                            <div className={styles.shipping}>
                                ...
                                <div className={styles.input}>
                                    <input type="text" name="" id="" placeholder="Card Number" required />
                                </div>
                                <div className={styles.input}>
                                    <input type="text" name="" id="" placeholder="Name on card" required />
                                </div>
                                <div className={styles.input}>
                                    <input type="text" name="" id="" placeholder="Expiration date (MM/YY)" required />
                                    <input type="text" name="" id="" placeholder="Security Code" required />
                                </div>
                            </div>
                            <div className={styles.buttons}>
